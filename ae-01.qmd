...
-   Use `?` before the function name to get more information about the pre-loaded data in R. Type this in the console. Click on `Get a glimpse of your data` in the help window. 


-   **Demo Together**: Now, filter out the any cars who weigh more than 4000 lbs *in a single pipeline*.
